...
from models.package_graph import (
    artifact_from_dict,
    artifact_to_dict,
    build_artifacts,
    build_components,
...
def inventory_source_provenance(
    *,
    ...
    return {
        ...
        "seed_inventory": "data.vlm_inventory" if include_vision else None,
    }
            ...
            "gguf_variants": [
                {
                    ...
                    "hypothetical": variant.hypothetical,
                }
    ...
    for d in data:
        ...
        gguf_variants = [
            GGUFVariant(
                ...
                hypothetical=v.get("hypothetical", False),
            )
